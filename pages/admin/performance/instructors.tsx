...
import ViewInstructor, {
    ViewInstructorDialog,
} from '../../../app/modules/admin/pages/performance/ViewInstructor'
import {
    ...
    const rows: ITableRow[] | undefined = useMemo(() => {
        return data?.map((item) => {
            return {
                ...
                'meta.totalCourse': (
                    <NumberFormat displayType="text" value={item.meta.totalCourse} />
                ),
                'meta.totalRevenue': <Price value={item.meta.totalRevenue} />,
                'meta.totalEnrollment': (
                    <NumberFormat displayType="text" value={item.meta.totalEnrollment} />
                ),
                'meta.courseRating': (
                    <NumberFormat
                        displayType="text"
                        value={item.meta.courseRating}
                        decimalScale={1}
                    />
                ),
